...
theme.titlebar_floating_button_focus_inactive  = themes_path.."default/titlebar/focus/floating_focus_inactive.png"
theme.titlebar_floating_button_normal_active = themes_path.."default/titlebar/unfocus/floating_normal_active.png"

...
local system_status         = require("src.widgets.components.system_status")
...
local control_center        = require("src.widgets.components.control_center")
local clock_widget          = require("src.widgets.components.clock")

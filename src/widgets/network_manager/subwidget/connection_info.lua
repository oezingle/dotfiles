...
local confirm_widget   = require("src.widgets.components.confirm")
local exitable_dialog  = require("src.widgets.util.exitable_dialog")
local heading_and_text = require("src.widgets.components.heading_and_text")
local id_placeholder   = require("src.widgets.components.id_placeholder")

local connection = require("src.widgets.network_manager.connection")

...
local switch_widget = require("src.widgets.components.switch")

local NM     = require("src.widgets.network_manager.nm")()
local client = require("src.widgets.network_manager.client")()

local saved_connections       = require("src.widgets.network_manager.subwidget.saved_connections")
local view_saved_connections  = saved_connections.view_saved_connections
local ap                      = require("src.widgets.network_manager.ap")
local connect_to_access_point = require("src.widgets.network_manager.connection").connect_to_access_point

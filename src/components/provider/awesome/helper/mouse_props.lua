...
---@param mods string[]
---@return Zingle.Components.helper.Modifiers
...
---@param click Zingle.Components.helper.ClickHandler?
---@param scroll Zingle.Components.helper.ScrollHandler?
...
---@param props Zingle.Components.helper.Mouseable<{}>
---@return LuaX.Props

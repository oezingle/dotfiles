local cpu_arc      = require("widgets.applet.system_info.cpu_arc")
local memory_usage = require("widgets.applet.system_info.memory_usage")
local awful        = require("awful")
local wibox        = require("wibox")
local atk          = require("widgets.applet.applet.toolkit")

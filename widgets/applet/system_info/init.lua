local applet              = require("widgets.applet.applet")
local pagination          = require("widgets.util.pagination")
local create_system_load  = require("widgets.applet.system_info.pages.system_load")
local create_system_specs = require("widgets.applet.system_info.pages.system_specs")
local create_awesome_info = require("widgets.applet.system_info.pages.awesome")
